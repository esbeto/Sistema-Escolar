    ...
    public partial class Salones_altasybajasgenerales : System.Web.UI.Page
    {
        string conexionest = ConfigurationManager.ConnectionStrings["conexionsql"].ToString();
          ...
          protected void llena_gv()
          {
              ...
              SqlCommand sqlCommand = new SqlCommand("select salon_desc, capacidad from cat_salon order by salon_desc ", sqlCon);
        ...
        protected void imgbtnsave_Click(object sender, ImageClickEventArgs e)
            ...
            SqlConnection sqlCon = new SqlConnection(conexionest);
             SqlCommand sqlCommand = new SqlCommand("insert into Cat_salon (salon_desc, capacidad) values ('"+Txtsalon.Text+"', '"+ Txtcap.Text+"')", sqlCon);
             sqlCommand.CommandType = CommandType.Text;
             sqlCommand.CommandTimeout = 4000;
             sqlCon.Open();
         ...
         protected void imgbtndelete_Click(object sender, ImageClickEventArgs e)
            {
            SqlConnection sqlCon = new SqlConnection(conexionest);
             SqlCommand sqlCommand = new SqlCommand("delete cat_salon where salon_desc = '"+Txtsalon.Text+"'", sqlCon);
             sqlCommand.CommandType = CommandType.Text;
             sqlCommand.CommandTimeout = 4000;
             sqlCon.Open();
             sqlCommand.ExecuteNonQuery(); //para update,inset,delete
