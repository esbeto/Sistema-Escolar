<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true"
    CodeBehind="niveles_altasybajasgenerales.aspx.cs" Inherits="Sistema_Escolar.Admin.niveles_altasybajasgenerales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:GridView ID="GridView6" runat="server" HeaderStyle-CssClass="headerGrid" AlternatingRowStyle-CssClass="alternatingRowGrid"
