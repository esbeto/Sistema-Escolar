<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true"
    CodeBehind="Horario_admin.aspx.cs" Inherits="Sistema_Escolar.Admin.Listado_mate_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GV2" runat="server" HeaderStyle-CssClass="headerGrid" AlternatingRowStyle-CssClass="alternatingRowGrid"
        AutoGenerateColumns="false" CssClass="Grid" RowStyle-CssClass="normalRowGrid"
        GridLines="Vertical" Style="margin-left: 20%;" Font-Bold="True" Font-Names="1"
        Font-Overline="False" Font-Size="Large" Font-Strikeout="False" ForeColor="#006600">
        ...
        <HeaderStyle CssClass="headerGrid" BackColor="#99FF66" BorderColor="#003300" BorderStyle="Groove">
        </HeaderStyle>
    ...
    <div style="margin-left: 80%;">
        ...
        <asp:ImageButton ID="imgbtnimprimir" runat="server" ImageUrl="~/Imagenes/IMPRIMIR.png"
            CommandName="imprimir" Height="43px" Width="61px" />
        <br />
        <br />
        <td class="style1">
            Si desea agregar o modificar el horario de un alumno primero debe ingresar la matricula,
            Despues seleccione el boton correpondiente. Gracias
        </td>
