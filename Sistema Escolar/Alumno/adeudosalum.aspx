<%@ Page Title="" Language="C#" MasterPageFile="~/AlumnosM.Master" AutoEventWireup="true" CodeBehind="adeudosalum.aspx.cs" Inherits="Sistema_Escolar.Alumno.adeudosalum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">

</asp:Content>
<asp:Content ID="Content2"  ContentPlaceHolderID="MainContent" runat="server">
  <div class="tituloPrincipal">RECIBO DE PAGO </div>
...
<div>
    <table >
        <tr>
            <td>
                NOMBRE DE LA ESCUELA * CARRERA</td>
            <td>
                FOLIO</td>
            <td>
                PERIODO</td>
        ...
        <tr>
            <td class="style5">
                <asp:Label ID="lblcod" runat="server" Text="CODIGO" CssClass="etiquetas"></asp:Label></td>
            <td>
                <asp:Label ID="lblcon" runat="server" Text="CONCEPTO" CssClass="etiquetas" 
                    Height="20px" Width="273px"></asp:Label></td>
            <td>
                <asp:Label ID="lblimp" runat="server" Text="IMPORTE" CssClass="etiquetas" 
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblconcepto" runat="server" Text=""></asp:Label></td>
            <td>
    ...
    <table class="style1">
        ...
        <tr>
            <td class="style3">
                <asp:Label ID="lblnref" runat="server" Text="No. Referencia:" 
        ...
        <tr>
            <td class="style3">
                <asp:Label ID="lblncue" runat="server" Text="No. de Cuenta:" 
                    CssClass="etiquetas"></asp:Label>
     ...
     <div style=" margin-left: 80%;">
        <asp:ImageButton ID="imgbtnimprimir" runat="server" 
            ImageUrl="~/Imagenes/IMPRIMIR.png" CommandName="imprimir" 
             Height="43px"  Width="61px" Visible="False"  />
            </div>
